...
std::ostream &
operator<<(std::ostream &, const ListItem<DataType> &);

template <class DataType> 
std::ostream &
operator<<(std::ostream &, const List<DataType> &);
#endif
...
#ifdef USEOSTREAM
        // miscellaneous
        template <typename DT> friend std::ostream& operator<<(std::ostream &, const ListItem<DT> &);
        template <typename DT> friend std::ostream& operator<<(std::ostream &, const List<DT> &);
#endif
