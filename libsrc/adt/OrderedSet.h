...
std::ostream &
operator<<(std::ostream &, const OrderedSet<KeyType> &);
#endif
...
#if USEOSTREAM
	// print ordered sets
        template <typename KT> friend std::ostream &operator<<(std::ostream &, const OrderedSet<KT> &);
#endif
