...
// print data
void 
SemanticRep::dumpData(std::ostream &) const
{
	return;
}

std::ostream &
operator<<(std::ostream &os, const SemanticRep &sr)
{
	sr.dumpData(os);
	return(os);
}
...
// print data
void 
Atomic::dumpData(std::ostream &os) const
{
	switch (type)
	{
	case Constant:
...
std::ostream &
operator<<(std::ostream &os, const Atomic &sr)
{
	sr.dumpData(os);
	return(os);
}
...
// print data
void 
Expression::dumpData(std::ostream &os) const
{
	os << "( ";
	if (left != NULL)
		os << *left;
...
std::ostream &
operator<<(std::ostream &os, const Expression &sr) {
	sr.dumpData(os);
	return(os);
}
...
int
Semantic::getClauses(ombt::List<Semantic *> &clist)
{
...
// print data
void
Semantic::dumpData(std::ostream &os) const
{
	os << *prep;
}

std::ostream &
operator<<(std::ostream &os, const Semantic &sr) {
	sr.dumpData(os);
	return(os);
}
