...
{
	cerr << endl << "TESTS FOR UnsignedInteger - multiplication and division ..." << endl;

////////////////////////////////////////////////////////////////////////////
	UnsignedInteger<50>::Number n1(2);
	n1[0] = 1;
	n1[1] = 1;
	UnsignedInteger<50> bint1(n1);
	cerr << endl << "bint1 = " << bint1 << endl;

	UnsignedInteger<50>::Number n2(2);
	n2[0] = 1;
	n2[1] = 1;
...
////////////////////////////////////////////////////////////////////////////
	UnsignedInteger<50>::Number n3(4);
	n3[0] = 1;
	n3[1] = 1;
	n3[2] = 1;
	n3[3] = 1;
	UnsignedInteger<50> bint3(n3);
	cerr << endl << "bint3 = " << bint3 << endl;

	UnsignedInteger<50>::Number n4(4);
	n4[0] = 1;
	n4[1] = 1;
	n4[2] = 1;
	n4[3] = 1;
...
////////////////////////////////////////////////////////////////////////////
	UnsignedInteger<50>::Number n5(1);
	n5[0] = 65535;
	UnsignedInteger<50> bint5(n5);
	cerr << endl << "bint5 = " << bint5 << endl;

	UnsignedInteger<50>::Number n6(1);
	n6[0] = 65535;
...
////////////////////////////////////////////////////////////////////////////
	UnsignedInteger<50>::Number n11(3);
	n11[0] = 1;
	n11[1] = 65535;
	n11[2] = 1;
	...
	UnsignedInteger<50>::Number n12(3);
	n12[0] = 65535;
	n12[1] = 0;
	n12[2] = 65535;
...
////////////////////////////////////////////////////////////////////////////
	UnsignedInteger<50>::Number n13(1);
	n13[0] = 10;
	UnsignedInteger<50> bint13(n13);
	cerr << endl << "bint13 = " << bint13 << endl;

	UnsignedInteger<50>::Number n14(1);
	n14[0] = 0;
	UnsignedInteger<50> bint14(n14);
...
////////////////////////////////////////////////////////////////////////////
	UnsignedInteger<50>::Number n15(2);
	n15[0] = 100;
	n15[1] = 100;
	UnsignedInteger<50> bint15(n15);
	cerr << endl << "bint15 = " << bint15 << endl;

	UnsignedInteger<50>::Number n16(1);
	n16[0] = 10;
...
////////////////////////////////////////////////////////////////////////////
	UnsignedInteger<50>::Number n17(3);
	n17[0] = 65535;
	n17[1] = 100;
	n17[2] = 65535;
	UnsignedInteger<50> bint17(n17);
	cerr << endl << "bint17 = " << bint17 << endl;

	UnsignedInteger<50>::Number n18(2);
	n18[0] = 10;
	n18[1] = 535;
	UnsignedInteger<50> bint18(n18);
	cerr << endl << "bint18 = " << bint18 << endl;

	UnsignedInteger<50> bint19;
	cerr << endl << "bint19 = " << bint19 << endl;

	UnsignedInteger<50> bint20;
...
////////////////////////////////////////////////////////////////////////////
	UnsignedInteger<50>::Number n21(20);
	for (int i=0; i<20; ++i)
	{
		n21[i] = i*i;
	}
	UnsignedInteger<50> bint21(n21);
	cerr << endl << "bint21 = " << bint21 << endl;

	UnsignedInteger<50>::Number n22(10);
	for (int i=0; i<10; ++i)
	{
		n22[i] = 2*i;
	}
	UnsignedInteger<50> bint22(n22);
	cerr << endl << "bint22 = " << bint22 << endl;

	UnsignedInteger<50> bint23;
	cerr << endl << "bint23 = " << bint23 << endl;

	UnsignedInteger<50> bint24;
