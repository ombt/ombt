...
{
	cerr << endl << "TESTS FOR UnsignedInteger - string operations ..." << endl;

	UnsignedInteger<50> bint0("65535");
	cerr << endl << "bint0 = " << bint0 << endl;
	UnsignedInteger<50> bint1("65536");
	cerr << endl << "bint1 = " << bint1 << endl;
	UnsignedInteger<50> bint2("1000000000000000000000000000000000000065536");
	...
	for (int arg=1; arg<argc; ++arg)
	{
		...
		cerr << "argv[" << arg << "] = " << UnsignedInteger<50>(argv[arg]) << endl;
	}

	cerr << endl;
	UnsignedInteger<100> bint3;
	UnsignedInteger<100> bint4;
	for (int arg=1; arg<argc; ++arg)
	{
		cerr << endl << "argv[" << arg << "] = " << argv[arg] << endl;
		bint3 = argv[arg];
		...
		cerr << "bint4=bint3*bint3 = " << (bint4=bint3*bint3).toString() << endl;
		cerr << "bint4/bint3 = " << (bint4/bint3).toString() << endl;
	}
