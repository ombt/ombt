...
protected:
    // track services
    typedef std::map<const std::string, MultiProcessDatagramServer::Handler * > SVCS;
    ...
    static MultiProcessDatagramServerPerProcess *object_;
};
...
protected:
    // track services
    typedef std::map<const std::string, MultiProcessStreamServer::Handler * > SVCS;
    typedef SVCS::const_iterator SVCSConstIter;
    typedef SVCS::iterator SVCSIter;
    SVCS services_;
    ...
    // signal handling
    static void handler(int);
    static MultiProcessStreamServerPerProcess *object_;
};
