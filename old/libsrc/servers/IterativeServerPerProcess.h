...
protected:
    // track services
    typedef std::map<const std::string, IterativeDatagramServer::Handler * > SVCS;
    ...
    static IterativeDatagramServerPerProcess *object_;
};
...
protected:
    // track services
    typedef std::map<const std::string, IterativeStreamServer::Handler * > SVCS;
    typedef SVCS::const_iterator SVCSConstIter;
    typedef SVCS::iterator SVCSIter;
    SVCS services_;
    ...
    // signal handling
    static void handler(int);
    static IterativeStreamServerPerProcess *object_;
};
