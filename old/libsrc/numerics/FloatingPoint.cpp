...
FloatingPoint<MD, DT, NT>::FloatingPoint():
...
template <int MD, class DT, class NT>
FloatingPoint<MD, DT, NT>::FloatingPoint(DT value):
	base_(0), maxdigits_(MD), ndigits_(0), n_()
{
	normalize(MD, value);
}
...
template <int MD, class DT, class NT>
FloatingPoint<MD, DT, NT>::FloatingPoint(const NT &n):
	base_(0), maxdigits_(MD), ndigits_(0), n_()
{
	normalize(n, MD);
}
...
template <int MD, class DT, class NT>
FloatingPoint<MD, DT, NT>::FloatingPoint(
	const FloatingPoint<MD, DT, NT> &n): 
...
template <int MD, class DT, class NT>
FloatingPoint<MD, DT, NT>::FloatingPoint(const std::string &cn):
	base_(0), maxdigits_(MD), ndigits_(0), n_()
{
	normalize(MD, cn);
}
...
template <int MD, class DT, class NT>
void
FloatingPoint<MD, DT, NT>::normalizeZero()
{
...
FloatingPoint<MD, DT, NT>::normalize(int maxdigits, DT value)
{
...
template <int MD, class DT, class NT>
FloatingPoint<MD, DT, NT> &
FloatingPoint<MD, DT, NT>::normalize(int maxdigits, const std::string &cvalue)
{
	if (cvalue.size() == 0) 
	...
	MustBeTrue((maxdigits_ = maxdigits) > 0);
        ...
        FloatingPoint<MD, DT, NT> ten(DT(10));
        FloatingPoint<MD, DT, NT> sum;
...
template <int MD, class DT, class NT>
FloatingPoint<MD, DT, NT> &
FloatingPoint<MD, DT, NT>::normalize(const NT &n, int maxdigits)
{
	MustBeTrue((maxdigits_ = maxdigits) > 0);
...
template <int MD, class DT, class NT>
FloatingPoint<MD, DT, NT> &
FloatingPoint<MD, DT, NT>::normalize(const FloatingPoint &n)
{
	if (this == &n)
	{
...
template <int MD, class DT, class NT>
std::ostream &
operator<<(std::ostream &os, const FloatingPoint<MD, DT, NT> &n)
{
	char comma = '(';
...
template <int MD, class DT, class NT>
std::string
FloatingPoint<MD, DT, NT>::toString() const
{
        static const FloatingPoint<MD, DT, NT> zero(DT(0));
        static const FloatingPoint<MD, DT, NT> ten(DT(10));

        FloatingPoint<MD, DT, NT> digit;
        FloatingPoint<MD, DT, NT> n(*this);
...
template <int MD, class DT, class NT>
DT &
FloatingPoint<MD, DT, NT>::operator[](int i)
{
	return(n_[i]);
}
...
template <int MD, class DT, class NT>
const DT &
FloatingPoint<MD, DT, NT>::operator[](int i) const
{
	return(n_[i]);
}
...
template <int MD, class DT, class NT>
int
FloatingPoint<MD, DT, NT>::numberOfDigits() const
{
	return ndigits_;
}
...
template <int MD, class DT, class NT>
int
FloatingPoint<MD, DT, NT>::maxNumberOfDigits() const
{
	return maxdigits_;
}
...
template <int MD, class DT, class NT>
FloatingPoint<MD, DT, NT> &
FloatingPoint<MD, DT, NT>::operator=(const FloatingPoint<MD, DT, NT> &n)
{
...
template <int MD, class DT, class NT>
FloatingPoint<MD, DT, NT> &
FloatingPoint<MD, DT, NT>::operator=(const std::string &sn)
{
...
template <int MD, class DT, class NT>
void
FloatingPoint<MD, DT, NT>::add(int imin, int imax, const NT &dmin, const NT &dmax)
{
	DT carryover = 0;
...
template <int MD, class DT, class NT>
FloatingPoint<MD, DT, NT>
FloatingPoint<MD, DT, NT>::operator+(const FloatingPoint<MD, DT, NT> &n) const
{
	return(FloatingPoint<MD, DT, NT>(*this) += n);
}

template <int MD, class DT, class NT>
void
FloatingPoint<MD, DT, NT>::subtract(int imin, int imax, const NT &dmin, const NT &dmax)
{
	DT borrow = 0;
	for (int i=0; i<imin; ++i)
	{
...
template <int MD, class DT, class NT>
FloatingPoint<MD, DT, NT>
FloatingPoint<MD, DT, NT>::operator-(const FloatingPoint<MD, DT, NT> &r) const
{
	return(FloatingPoint<MD, DT, NT>(*this) -= r);
}

template <int MD, class DT, class NT>
void
FloatingPoint<MD, DT, NT>::multiply(int imin, DT dmin, int imax, const NT &dmax, FloatingPoint<MD, DT, NT> &product)
{
	for (int i=0; i<imin; ++i)
	{
		product.n_[i] = DT(0);
...
template <int MD, class DT, class NT>
void
FloatingPoint<MD, DT, NT>::multiply(int imin, int imax, const NT &dmin, const NT &dmax)
{
	FloatingPoint<MD, DT, NT> sum;
	for (int i=0; i<imin; ++i)
	{
		FloatingPoint<MD, DT, NT> product;
...
template <int MD, class DT, class NT>
FloatingPoint<MD, DT, NT> &
FloatingPoint<MD, DT, NT>::operator*=(const FloatingPoint<MD, DT, NT> &r)
{
...
template <int MD, class DT, class NT>
void
FloatingPoint<MD, DT, NT>::divide(int imin, int imax, const NT &dmin, const NT &dmax)
{
}
...
{
	static const FloatingPoint<MD, DT, NT> zero(DT(0));
	static const FloatingPoint<MD, DT, NT> one(DT(1));
	static const FloatingPoint<MD, DT, NT> maxdigit(DigitTypePolicy<DT, sizeof(DT)>::MaxDigit);
...
template <int MD, class DT, class NT>
int
FloatingPoint<MD, DT, NT>::compare(const FloatingPoint<MD, DT, NT> &r) const
{
	if (ndigits_ < r.ndigits_)
		return -1;
...
template <int MD, class DT, class NT>
FloatingPoint<MD, DT, NT> &
FloatingPoint<MD, DT, NT>::operator=(NT r)
{
	return(normalize(FloatingPoint<MD, DT, NT>(r)));
}
...
FloatingPoint<MD, DT, NT>::operator+=(NT r)
{
	return(normalize(*this += FloatingPoint<MD, DT, NT>(r)));
}

template <int MD, class DT, class NT>
FloatingPoint<MD, DT, NT>
FloatingPoint<MD, DT, NT>::operator+(NT r) const
{
	return(FloatingPoint<MD, DT, NT>(*this) += r);
}
...
FloatingPoint<MD, DT, NT>::operator%=(NT r)
{
	return(normalize(*this -= (*this/FloatingPoint<MD, DT, NT>(r))*FloatingPoint<MD, DT, NT>(r)));
}
...
template <int MD, class DT, class NT>
FloatingPoint<MD, DT, NT>
operator+(NT n, const FloatingPoint<MD, DT, NT> &r)
{
	return(FloatingPoint<MD, DT, NT>(n) += r);
}
...
FloatingPoint<MD, DT, NT>::operator==(NT r) const
{
	return(*this == FloatingPoint<MD, DT, NT>(r));
}
