...
main(int argc, char **argv)
{
    ...
    cout << "Smart crunching without checks ..." << endl;
    NanoSecTime sm_wo_cks_s;
    smart_sequences_found = 0;
    for (int row=0; row<KeyBoard::max_row; ++row)
    {
        for (int col=0; col<KeyBoard::max_col; ++col)
        {
    ...
    NanoSecTime cnt_e;
    cout << "Number of sequences found (count only): " << smart_sequences_found << endl;
