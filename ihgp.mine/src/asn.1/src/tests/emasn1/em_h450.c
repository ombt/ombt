/* $CCRev: ./src/h323ds/3rdparty/elemedia/ex3230s/asn1/emasn1/em_h450.c@@/main/1 */
/************************************************************************
 *
 ...
 *
 ************************************************************************/
/* SCCS id:	@(#)em_h450.c	7.1.2.2	03/14/00	*/
 ...
 * 06/17/1998   Changed h450.c to em_h450.c.
 * 03/29/1999	Included PSOS simulator support
 */


#ifdef sun5
#include "../../os/asn1/sun5/em_h450.c"
#endif

#ifdef uw
#include "../../os/asn1/uw/em_h450.c"
#endif

#ifdef hpux
#include "../../os/asn1/hpux/em_h450.c"
#endif

#ifdef win32
#include "../../os/asn1/win32/em_h450.c"
#endif

#ifdef inferno
#if (CPU == 386)
#include "../../os/asn1/inferno/386/em_h450.c"
#elif (CPU == R4000)
#include "../../os/asn1/inferno/R4000/em_h450.c"
#elif (CPU == R4700)
#include "../../os/asn1/inferno/R4000/em_h450.c"
#else
...
#ifdef comos
#if (CPU == X86)
#include "../../os/asn1/comos/X86/em_h450.c"
#else
...
#include "../../os/asn1/vxworks/SIMSPARCSOLARIS/em_h450.c"
#elif (CPU == SH4)
#include "../../os/asn1/vxworks/SH4/em_h450.c"
#elif (CPU == R4000)
#if (CPU_VAR == R4700)
#ifdef MIPSEB
#include "../../os/asn1/vxworks/R4700EB/em_h450.c"
#else
#include "../../os/asn1/vxworks/R4700EL/em_h450.c"
#endif
#else
