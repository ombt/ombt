...
main(int, char **)
{
	Money assessed("Assessed Real Estate Value", 0.0);
	...
	Number rate("Real Estate Tax Rate", 0.0);
	Money taxes("Monthly Real Estate Taxes", 0.0);
	Money monthlyPayment("Total Monthly Payment", 0.0);
	...
	taxes = rate*assessed/MonthsPerYear/100.0;
	monthlyPayment = taxes + payment;
