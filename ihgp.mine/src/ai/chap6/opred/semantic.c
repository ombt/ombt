...
int
Semantic::getClausesAsLists(Clause &clause, Term &term, int isnegated)
{
...
int
Semantic::getClausesAsLists(Clause &clause)
{
	// check type of record
	if (isExpression())
	{
...
int
Semantic::getClausesAsLists(Set_List<Clause> &clist)
{
