#ident "@(#)/usr/src/head/reloc.h	3.1.1.1 6/1/90 07:29:49 - (c) Copyright 1988, 1989, 1990 Amdahl Corporation"
...
/*
 * Amdahl 470/580 Processors
 */
#define R_REL2BYT       017
#define R_REL3BYT       020
#define R_RELNEG        0100000
