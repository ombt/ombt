	...
	map()
{
	...
	// new map.
	//
	BinaryTree_AVL_Iterator_LevelOrder<Tuple<KeyType, DataType *> >
		srcmapIter(src.map);
...
{
	BinaryTree_AVL_Iterator_InOrder<Tuple<KeyType, DataType *> > mapIter(map);
...
{
	BinaryTree_AVL_Iterator_InOrder<Tuple<KeyType, DataType *> > dmapIter(d.map);
