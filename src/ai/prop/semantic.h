...
protected:
	...
	virtual int getClauses(ombt::Set_List<Clause> &, Clause &, int, int, int) const = 0;
...
protected:
	...
	// convert to CNF functions
	virtual int getClauses(ombt::Set_List<Clause> &, Clause &, int, int, int) const;

	// print data
	void dumpData(std::ostream &) const;
	friend std::ostream &operator<<(std::ostream &, const Atomic &);
...
public:
	...
	int getClauses(ombt::Set_List<Clause> &, Clause &) const;
	int getClauses(ombt::Set_List<Clause> &, Clause &, int, int, int) const;
