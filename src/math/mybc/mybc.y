...
extern char *optarg;
extern Complex<double> number2complex(VALUE );
...
extern VALUE number2double(VALUE );
extern void graph();
extern void initgraph();
extern void mybcerror(const char *, int );
extern void storexy(VALUE , VALUE );
...
start:
	...
	| start expr newline
	{
		...
		case RATIONAL:
		{
			Rational<long> r($2.value.rvalue);
			r.print(stdout, "%ld", "\n");
			break;
		}
		case DOUBLE:
...
cmd:
	...
	| HELP
	{
		...
		printf("[0-9]*[rR] - rational numbers\n");
...
or:
	...
	| or OR and
	{
		...
		case ULONG:
			...
			case RATIONAL:
				$$.value.lvalue =
					$1.value.ulvalue || $3.value.rvalue.n_;
				break;
			case COMPLEX:
			{
				Complex<double> 
		...
		case LONG:
			...
			case RATIONAL:
				$$.value.lvalue =
					$1.value.lvalue || $3.value.rvalue.n_;
				break;
			case COMPLEX:
			{
				Complex<double> 
		...
		case RATIONAL:
			...
			case ULONG:
				$$.value.lvalue =
					$1.value.rvalue.n_ || $3.value.ulvalue;
				break;
			case LONG:
				$$.value.lvalue =
					$1.value.rvalue.n_ || $3.value.lvalue;
				break;
			case DOUBLE:
				$$.value.lvalue =
					$1.value.rvalue.n_ || $3.value.dvalue;
				break;
			case RATIONAL:
				$$.value.lvalue =
					$1.value.rvalue.n_ || $3.value.rvalue.n_;
				break;
			case COMPLEX:
			{
				Complex<double> 
					c1((double)$1.value.rvalue.n_);
				Complex<double> 
					c3($3.value.cvalue.r,$3.value.cvalue.i);
				try {
					$$.value.lvalue = (c1 || c3);
		...
		case DOUBLE:
			...
			case RATIONAL:
				$$.value.lvalue =
					$1.value.dvalue || $3.value.rvalue.n_;
				break;
			case COMPLEX:
			{
				Complex<double> 
	...
	| bitor BITOR bitxor
	{
		...
		case ULONG:
			...
			case LONG:
				...
				break;
			case RATIONAL:
				yyerror((const char *)"| cannot be applied to rational.");
				YYERROR;
			case DOUBLE:
...
equality:
	...
	| equality EQUAL rel
	{
		...
		case ULONG:
			...
			case RATIONAL:
				$$.value.lvalue =
					$3.value.rvalue.d_*$1.value.ulvalue == $3.value.rvalue.n_;
				break;
			case COMPLEX:
			{
				Complex<double> 
		...
		case LONG:
			...
			case RATIONAL:
				$$.value.lvalue =
					$3.value.rvalue.d_*$1.value.lvalue == $3.value.rvalue.n_;
				break;
			case COMPLEX:
			{
				Complex<double> 
		...
		case RATIONAL:
			...
			case ULONG:
				$$.value.lvalue =
					$1.value.rvalue.n_ == $3.value.ulvalue*$1.value.rvalue.d_;
				break;
			case LONG:
				$$.value.lvalue =
					$1.value.rvalue.n_ == $3.value.lvalue*$1.value.rvalue.d_;
				break;
			case DOUBLE:
			{
				double dr = (double)$1.value.rvalue.n_/
					    (double)$1.value.rvalue.d_;
				$$.value.lvalue =
					::abs($3.value.dvalue - dr) <= deps;
				break;
			}
			case RATIONAL:
				$$.value.lvalue =
					$1.value.rvalue.n_ == $3.value.rvalue.n_ && 
					$1.value.rvalue.d_ == $3.value.rvalue.d_;
				break;
			case COMPLEX:
			{
				Complex<double> 
		...
		case DOUBLE:
			...
			case RATIONAL:
			{
				double dr = (double)$3.value.rvalue.n_/
					    (double)$3.value.rvalue.d_;
				$$.value.lvalue =
					::abs($1.value.dvalue - dr) <= deps;
				break;
			}
			case COMPLEX:
			{
	...
	| equality NOTEQUAL rel
	{
		...
		case RATIONAL:
			...
			case RATIONAL:
				$$.value.lvalue =
					!($1.value.rvalue.n_ == $3.value.rvalue.n_ && $1.value.rvalue.d_ == $3.value.rvalue.d_);
				break;
			case COMPLEX:
			{
				Complex<double> 
	...
	| rel LT shift
	{
		...
		case DOUBLE:
			...
			case RATIONAL:
			{
				double dr = (double)$3.value.rvalue.n_/
					    (double)$3.value.rvalue.d_;
				$$.value.lvalue = $1.value.dvalue < dr;
				break;
			}
			case COMPLEX:
			{
		...
		case RATIONAL:
			...
			case DOUBLE:
			{
				double dr = (double)$1.value.rvalue.n_/
					    (double)$1.value.rvalue.d_;
				$$.value.lvalue = (dr < $3.value.dvalue);
				break;
			}
			case RATIONAL:
			{
				Rational<long> r1($1.value.rvalue);
				Rational<long> r3($3.value.rvalue);
				$$.value.lvalue = (r1 < r3);
				break;
			}
			case COMPLEX:
...
add:
	...
	| add PLUS mult
	{
		...
		case ULONG:
			...
			{
				$$.type = RATIONAL;
				Rational<long> r1($1.value.ulvalue);
				Rational<long> r3($3.value.rvalue);
				r1 += r3;
				r1.internal($$.value.rvalue);
				break;
			}
			case DOUBLE:
				$$.type = DOUBLE;
		...
		case LONG:
			...
			{
				$$.type = RATIONAL;
				Rational<long> r1($1.value.lvalue);
				Rational<long> r3($3.value.rvalue);
				r1 += r3;
				r1.internal($$.value.rvalue);
				break;
		...
		case RATIONAL:
			...
			case ULONG:
			{
				$$.type = RATIONAL;
				Rational<long> r1($1.value.rvalue);
				Rational<long> r3($3.value.ulvalue);
				r1 += r3;
				r1.internal($$.value.rvalue);
				break;
			}
			case LONG:
			{
				$$.type = RATIONAL;
				Rational<long> r1($1.value.rvalue);
				Rational<long> r3($3.value.lvalue);
				r1 += r3;
				r1.internal($$.value.rvalue);
				break;
			}
			case DOUBLE:
			{
				...
				double dr = (double)$1.value.rvalue.n_/
					    (double)$1.value.rvalue.d_;
				$$.value.dvalue = dr + $3.value.dvalue;
				break;
			}
			case RATIONAL:
			{
	...
	| LPAREN type RPAREN cast
	{
		...
		case ULONG:
			...
			case RATIONAL:
				$$.type = ULONG;
				$$.value.ulvalue = 
					(unsigned long)($4.value.rvalue.n_/$4.value.rvalue.d_);
				break;
			case COMPLEX:
		...
		case LONG:
			...
			case RATIONAL:
				$$.type = LONG;
				$$.value.lvalue = 
					(long)($4.value.rvalue.n_/$4.value.rvalue.d_);
				break;
			case COMPLEX:
				yyerror((const char *)"cannot typecast complex.");
				YYERROR;
		...
		case DOUBLE:
			...
			case RATIONAL:
				$$.type = DOUBLE;
				$$.value.dvalue = 
					(double)($4.value.rvalue.n_)/(double)($4.value.rvalue.d_);
				break;
			case COMPLEX:
				yyerror((const char *)"cannot typecast complex.");
				YYERROR;
		...
		case COMPLEX:
			...
			case RATIONAL:
				$$.type = COMPLEX;
				$$.value.cvalue.r = (double)($4.value.rvalue.n_)/(double)($4.value.rvalue.d_);
				$$.value.cvalue.i = 0;
				break;
			case COMPLEX:
				$$ = $4;
...
unary:
	...
	| NOT cast
	{
		...
		case LONG:
			...
			break;
		case RATIONAL:
			$2.value.rvalue.n_ = !($2.value.rvalue.n_);
			break;
		case COMPLEX:
...
primary:
	...
	| CSC LPAREN expr RPAREN
	{
		...
		else
		{
			...
			{
				yyerror((const char *)"complex csc failed.");
				YYERROR;
			}
			try {
				c2 /= 1.0;
...
number2double(VALUE number)
{
	...
	case RATIONAL:
		number.type = DOUBLE;
		number.value.dvalue = (double)number.value.rvalue.n_ / 
				      (double)number.value.rvalue.d_;
		break;
	case DOUBLE:
		break;
	default:
