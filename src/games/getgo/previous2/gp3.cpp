...
public:
    ...
    void brute_force_sequences(int sequence_number, 
                               int number_of_vowels, 
                               int row, 
                               int col,
                               long &seq_found,
                               long &nodes_visited);
    void smart_sequences(int sequence_number, 
                         int number_of_vowels, 
                         int row, 
                         int col,
                         long &seq_found,
...
void
KeyBoard::brute_force_sequences(int seq_num, 
                                int vowels, 
                                int r, 
                                int c,
                                long &seq_found,
                                long &nodes_visited)
{
    ...
    for (int move=0; el_moves[move][0] != 0; ++move)
    {
        int new_r = r+el_moves[move][0];
        int new_c = c+el_moves[move][1];
        brute_force_sequences(seq_num, vowels, new_r, new_c, seq_found, nodes_visited);
    }
}

void
KeyBoard::smart_sequences(int seq_num, 
                          int vowels, 
                          int r, 
                          int c,
                          long &seq_found,
                          long &nodes_visited)
{
    ...
    if (vowels >= 1)
    {
        ...
        for (int i=0; i<=mi; ++i)
        {
            ...
            smart_sequences(seq_num, vowels, new_r, new_c, seq_found, nodes_visited);
        }
...
main(int argc, char **argv)
{
    ...
    for (int row=0; row<KeyBoard::max_row; ++row)
    {
        ...
        {
            b.brute_force_sequences(sequence_length, 
                                    number_of_vowels, 
                                    row, 
                                    col,
    ...
    cout << "Nodes visited (brute force): " << brute_force_nodes_visited << endl;
    ...
    for (int row=0; row<KeyBoard::max_row; ++row)
    {
        for (int col=0; col<KeyBoard::max_col; ++col)
        {
            ...
            // generate sequences
            b.smart_sequences(sequence_length, 
                              number_of_vowels, 
                              row, 
                              col,
    ...
    cout << "Nodes visited (smart): " << smart_nodes_visited << endl;
