#ident "@(#)/usr/src/uts/uts/sys/filehdr.h	6.1.1.1 6/2/90 07:16:22 - (c) Copyright 1988, 1989, 1990 Amdahl Corporation"
/* */
 ...
 *	F_EFT		File is EFT compatible
 *	F_EFTI		File is EFT independent (contains no EFT sensitive
 *			data.
 *				replaced functions
 *      F_ADBIG         (UTS only) Address space to be more than 16M.
 *      F_AD16M         (UTS only) Address space to be limited to 16M (24 bits)
 */
...
#define  F_EFT		0010000
#define  F_EFTI		0020000
#define  F_ADBIG        0040000
#define  F_AD16M        0100000
...
#define	M68TVMAGIC	0211
	...
	/* IBM 370 */
#define	U370WRMAGIC	0535	/* writeble text segments	*/
#define	U370ROMAGIC	0530	/* readonly sharable text segments	*/
...
#define AMDROMAGIC      0534    /* readonly sharable text segments */
        ...
        /* VIPL */
#define VIPLMAGIC       0599    /* VIPL IPL'able file */
