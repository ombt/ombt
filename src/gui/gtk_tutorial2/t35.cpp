...
#else
  p1 = gdk_pixbuf_new_from_file("PNG/48_iphone_icons.png", &err); 
  p2 = gdk_pixbuf_new_from_file("PNG/48_ipod.png", &err);
  p3 = gdk_pixbuf_new_from_file("PNG/48_graph_multicolor.png", &err);
  p4 = gdk_pixbuf_new_from_file("PNG/48_monitor.png", &err);
#endif
