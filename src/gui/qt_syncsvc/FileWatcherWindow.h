...
public:
    FileWatcherWindow(const QString &dasname, DHMWindow *dhmwindow);
    ~FileWatcherWindow();
...
signals:
    ...
    void addDAS(const QString &das);
    void removeDAS(const QString &das);
    void addFileNodeToDAS(const QString &das, const QString &filenode);
    void removeFileNodeToDAS(const QString &das, const QString &filenode);
    void statusMessage(const QString &path);
