 ...
 */
BiDepthGraph::BiDepthGraph(int op, Node *start, Node *goal)
 ...
 * in the graph. A depth-first search is established by adding the node
 * to the head of xOPEN.
 */
int BiDepthGraph::add(IntrList<Node> *x_open, IntrList<Node> *x_closed,
Node *succ)
{
    /*
