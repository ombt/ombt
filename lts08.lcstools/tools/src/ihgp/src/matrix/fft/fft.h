 ...
 * sequence, though the package lets user to take only real and/or imaginaire
 ...
 * Formula (3) is nothing but a trapezoid rule approximation to the
 * Fourier integral; the trapezoid rule is the most stable one with respect
 * to the noise in the input data. Again, x[j] may be either real or
