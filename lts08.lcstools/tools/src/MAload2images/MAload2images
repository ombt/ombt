...
usage="
usage: $(basename ${0}) [-?xld] branch branchtype imagetype btsbranch
...
allowed image types are:
	all ana atmds3 cm cpu ds1_2 ds1_c ds1 ds3 e1
	ena2 ena octds3_2 octds3_3 octds3 pna tdmoc
	trids3_3 trids3_d trids3 voip6 voip vs2 vs3
	bts tca
"
#
