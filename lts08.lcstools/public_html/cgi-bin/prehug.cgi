...
print "<center>\n";
#
print "<h3> Pre-HUG (FTP and Extract Tar Files)</h3>\n";
#
print "<form method=\"post\" action=\"prehug2.cgi\">\n";
#
print "<hr>\n";
print "<h4>Lab ID: ";
...
#
print "<h4>\n";
print "SET-SID ID (if different than Lab ID):\n";
print "<input type=text name=\"maswitchid\" value=\"\" size=20>\n";
print "</h4>\n";
#
print "<h4>Branch: ";
...
print "</h4>\n";
#
print "<h4>Filter available tar files using 'chassis2ioms' relation?\n";
