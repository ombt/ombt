...
sub rtrveqptdata {
	...
	print "</h4>\n";
	#
	print "<h4>Choose TL1 Retrieve Cmd:\n";
	...
	print "</select></h4>\n";
	#
	print "<h4>Additional Retrieve TL1 Parameters:<br>\n";
	print "<input type=text name=\"tl1params\" value=\"\" size=30>\n";
	print "</h4>\n";
	#
	print "<h4>OR, Enter</h4>\n";
	print "<h4>Other TL1 Cmd:<br>\n";
	print "<input type=text name=\"othertl1cmd\" value=\"\" size=40>\n";
	print "\n";
	print "</h4>\n";
	#
	print "<h4>\n";
